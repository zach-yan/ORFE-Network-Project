...
metrics_df = metrics_df.merge(degree_centrality, on='vertex', how='left')
metrics_df = metrics_df.merge(closeness_centrality, on='vertex', how='left')
metrics_df = metrics_df.merge(betweenness_centrality, on='vertex', how='left')
